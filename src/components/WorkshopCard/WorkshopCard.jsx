...
function WorkshopCard({ workshop }) {
  return (
    <div className="glass-panel border border-reactor-blue/20 hover:border-reactor-blue/50 hover:shadow-blue-glow rounded-lg overflow-hidden flex flex-col justify-between transition-all duration-300 relative group p-6">
      ...
      <span className="absolute top-2 left-2 text-[8px] font-mono text-reactor-blue/30 select-none font-bold">+ AX-2026</span>
      <span className="absolute bottom-2 right-2 text-[8px] font-mono text-reactor-blue/30 select-none font-bold">WORKSHOP // DEMO</span>
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="space-y-1.5">
          <p className="text-[10px] font-orbitron tracking-wider text-gray-500 font-bold uppercase">WORKSHOP PERKS</p>
      ...
      <div className="relative z-10 mt-6 pt-4 border-t border-white/5">
        <button
          onClick={() => {
            alert(`Demo registration interest opened for ${workshop.title}. Fee: ${workshop.fee}. Replace this with the final workshop registration flow.`)
          }}
